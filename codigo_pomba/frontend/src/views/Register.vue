...
const initialValues = { nombre: '', apellidos: '', email: '', password: '', confirmPassword: '' }
...
const onFormSubmit = async (event) => {
  ...
  try {
    ...
    errorApi.value = getErrorMessage(error)
  } finally {
    loading.value = false
  }
}
    ...
    <div class="bg-surface-0 dark:bg-surface-900 p-8 md:p-12 shadow-sm rounded-2xl w-full max-w-sm flex flex-col gap-8">
      ...
      >
        ...
        <div
          ...
          class="flex items-center gap-2 text-green-600 bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-800/30 text-sm"
        >
